        ...
        if (this.props.filter === "group") {
            ...
            return (
                <div className="group-select fc-button-group">
                    ...
                    <button id="FI" type="button" className="fc-button fc-state-default" onClick={this.groupSelect}>F</button>
                    <button id="I" type="button" className="fc-button fc-state-default" onClick={this.groupSelect}>I</button>
                    <button id="II" type="button" className="fc-button fc-state-default" onClick={this.groupSelect}>II</button>
                    <button id="III" type="button" className="fc-button fc-state-default" onClick={this.groupSelect}>III</button>
                    <button id="All" type="button" className="fc-button fc-state-default fc-state-active fc-corner-right" onClick={this.groupSelect}>IV-VII</button>
                </div>
            )
        } else {
            return null;
